...
public class ResponseDto {
    ...
    public static ResponseEntity<ResponseDto> ValidationEmail() {
        ResponseDto body = new ResponseDto(ResponseCode.NOT_EXIST_USER, ResponseMessage.VALIDATION_FAIL);
